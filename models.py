...
class Department(models.Model):
    ...
    leader = models.ForeignKey('Employee', on_delete=models.SET_NULL, null=True, blank=True, related_name='leading_departments', verbose_name='部门负责人')
...
class ResearchTeam(models.Model):
    ...
    leader = models.ForeignKey('Employee', on_delete=models.SET_NULL, null=True, blank=True, related_name='leading_teams', verbose_name='团队负责人')
...
class Employee(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name='所在部门')
    team = models.ForeignKey(ResearchTeam, on_delete=models.SET_NULL, null=True, blank=True, verbose_name='所属科研创新团队')
