...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-d8nxe*7vq1ry6-p3qzm-b&847rslgh)7g9zy!y@n^zph-rera7')
...
JWT_REFRESH_TOKEN_LIFETIME = int(os.getenv('JWT_REFRESH_TOKEN_LIFETIME', '86400'))  # 24 hours
