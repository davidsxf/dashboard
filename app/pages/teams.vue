...
// 搜索科研团队
const handleSearch = () => {
  fetchTeams({ name: searchQuery.value });
};
...
<template>
  <UDashboardPanel>
    <template #header>
      <UDashboardNavbar title="科研创新团队管理">
        <template #leading>
    ...
    <template #body>
      <div class="mb-6">
        <p class="text-sm text-gray-600 dark:text-gray-400">管理所有科研创新团队</p>
      </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
        ...
        <!-- 空状态 -->
        <div v-else-if="teams.length === 0" class="p-8 text-center text-gray-600 dark:text-gray-400">
          没有找到科研团队数据
        </div>
      </div>
